...
namespace NagadDOTNETIntegration.Functions
{
    internal class AddNumber
    {
        private static HttpListener httpListener;
        public static async Task AddNumberForTokenization()
        {
            Console.WriteLine("\n");
            ...
            var responseContent = "";
            string SecureHandShakeAPI = $"http://sandbox.mynagad.com:10080/remote-payment-gateway-1.0/api/dfs/check-out/initialize/{GlobalVariables.MerchantId}/{order_id}?purpose=ECOM_TOKEN_GEN";
            try
            {
